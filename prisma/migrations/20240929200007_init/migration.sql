...
CREATE TABLE "ProductVariationType" (
    ...
    CONSTRAINT "ProductVariationType_pkey" PRIMARY KEY ("productId","variationTypeId")
);
...
-- AddForeignKey
ALTER TABLE "Variation" ADD CONSTRAINT "Variation_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "Variation"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Variation" ADD CONSTRAINT "Variation_typeId_fkey" FOREIGN KEY ("typeId") REFERENCES "VariationType"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Stock" ADD CONSTRAINT "Stock_variationId_fkey" FOREIGN KEY ("variationId") REFERENCES "Variation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AvailableStock" ADD CONSTRAINT "AvailableStock_variationId_fkey" FOREIGN KEY ("variationId") REFERENCES "Variation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CartProductVariation" ADD CONSTRAINT "CartProductVariation_variationId_fkey" FOREIGN KEY ("variationId") REFERENCES "Variation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
